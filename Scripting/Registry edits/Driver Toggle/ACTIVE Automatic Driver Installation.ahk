...
Gui, Add, Button, x15 y75 w60 gOFF, OFF
Gui, Add, Button, x+20 w60 gON, ON
Gui, Add, Button, x+25 w60 gCancel, CANCEL
Gui, Font, s11 cBlack, Verdana
Gui, Add, Text, x25 y15, Automatic Driver Installation Toggle. 
Gui, Add, Text, x25 y50, TOGGLE OPTIONS FORCE REBOOT
Gui, Show, w300 h125, Test
Return
...
OFF:
	...
	MsgBox, Automatic driver installation is now OFF. System will now reboot.
	Shutdown, 6
Return
...
ON:
	RegWrite, REG_DWORD, HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching, SearchOrderConfig, 00000001
  	MsgBox, Automatic driver installation is now ON. System will now reboot.
	Shutdown, 6
Return
